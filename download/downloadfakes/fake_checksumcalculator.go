...
type FakeChecksumCalculator struct {
	CalculateChecksumStub        func(filePath string, hashFunc hash.Hash) (string, error)
...
func (fake *FakeChecksumCalculator) CalculateChecksum(filePath string, hashFunc hash.Hash) (string, error) {
	...
	fake.recordInvocation("CalculateChecksum", []interface{}{filePath, hashFunc})
	fake.calculateChecksumMutex.Unlock()
	if fake.CalculateChecksumStub != nil {
		return fake.CalculateChecksumStub(filePath, hashFunc)
	}
	if specificReturn {
...
func (fake *FakeChecksumCalculator) CalculateChecksumArgsForCall(i int) (string, hash.Hash) {
	fake.calculateChecksumMutex.RLock()
	defer fake.calculateChecksumMutex.RUnlock()
	return fake.calculateChecksumArgsForCall[i].filePath, fake.calculateChecksumArgsForCall[i].hashFunc
}
